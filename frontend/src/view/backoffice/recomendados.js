...
export default function RecomendadosComponent() {
    ...
    useEffect(() => {
        axios.get(ip + '/livros/list_recomendados?ordem=' + ordemLivro + '&filtro=' + filtroLivro + '&categoria=' + categoriaid, authHeader())
    ...
    }, [filtroLivro, ordemLivro, categoriaid, id])
    function Add(idl) {
